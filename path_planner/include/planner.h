...
class Planner {
  ...
  */
  ...
  /*!
     \brief Publish the defined goal just for debug
  */
  void pubDefinedGoal(const Node3D nGoal);
 ...
 private:
  ...
  /// A publisher publishing the defined goal position for RViz
  ros::Publisher pubGoal;
  /// A publisher publishing the defined map for RViz
  ...
  /// Flag for allowing the planner to replan
  bool isReplan = true;
