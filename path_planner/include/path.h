...
class Path {
 public:
  ...
  Path(bool smoothed = false) {
    ...
    std::string pathParkingTopic = "/parking_path";

    if (smoothed) {
      pathTopic = "/sPath";
      pathNodesTopic = "/sPathNodes";
      pathVehicleTopic = "/sPathVehicle";
      pathParkingTopic = "/parking_path";
    ...
    pubPathParking = n.advertise<common::PathPlan>(pathParkingTopic, 1);
  ...
  /*!
     ...
     \param i a parameter for counting the number of nodes
  */
  void updatePath(std::vector<Node3D> nodePath, Node3D nStart);
  /*!
  ...
  */
  ...
  void addPathParking(const Node3D& node, int i, Node3D nStart);
  ...
  /// Publishes the vehicle along the path
  void publishPathParking() { pubPathParking.publish(pathParking); }
